...
if __name__ == "__main__":
    power_ratio_list, trans_list = simulate_bdc(wavelengths=[1.55e-6], wg_width=0.45e-6, wg_gap=0.2e-6,
                                                w1=4.60968766569e-07, w3=5.32707329999e-07, t_length=1.62438939634e-05
                                                )

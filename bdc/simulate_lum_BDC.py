...
# It is located in the root of the distribution folder. (luceda_academy_34-101/library/si_fab/si_fab/ipkiss/si_fab/components/dir_coupler/simulation/simulate_lum_BDC.py)

from ipkiss3 import all as i3
from ipkiss3.all.device_sim import lumerical_macros


def simulate_bdc(layout, project_folder, mesh_accuracy=1, wavelengths=(1.5, 1.6, 100)):
